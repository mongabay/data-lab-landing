...
const Button = ({ children, className, ...props }: ButtonProps | AnchorProps) => {
  ...
  const c = cx(
    'flex items-center justify-center w-full text-center font-open text-base font-semibold leading-normal text-primary sm:w-fit rounded-3xl px-8 py-3 focus-visible:outline-primary focus-visible:outline-offset-4',
    className,
